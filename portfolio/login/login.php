                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="POST">
                    ...
                    <div  class="form-group">
                      <input type="text" class="form-control form-control-user" name="txtUsuario" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Usuario">
                    </div>
                    <div class="form-group">
                      <input type="password"  name="txtClave" class="form-control form-control-user" id="exampleInputPassword" placeholder="Clave">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name=btnEntrar class="btn btn-primary btn-user btn-block">
                      Entrar
                    </button>
                    <hr>
                  </form>
